...
<HeightHistogram data={all} client:load />
...
<HeightHistogram data={boulder} client:load />

## Lead Finalists

<HeightHistogram data={lead} client:load />

## Speed Finalists

<HeightHistogram data={speed} client:load />
