...
<div style="height: 450px;">
  <HeightHistogram data={all} client:only />
</div>
...
<div style="height: 450px;">
  <HeightHistogram data={boulder} client:only />
</div>

## Lead Finalists

<div style="height: 450px;">
  <HeightHistogram data={lead} client:only />
</div>

## Speed Finalists

<div style="height: 450px;">
  <HeightHistogram data={speed} client:only />
</div>
