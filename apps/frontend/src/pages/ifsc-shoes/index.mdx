...
import BoulderDark from "./_components/plots/shoes/BoulderDark.astro";
import BoulderWhite from "./_components/plots/shoes/BoulderWhite.astro";
import LeadDark from "./_components/plots/shoes/LeadDark.astro";
import LeadWhite from "./_components/plots/shoes/LeadWhite.astro";
export const __ = undefined;

<PlotlyScript />

Ever wonder what shoes are worn by the world's best climbers? I do. Especially
when my shoes inevitablely start forming a hole every year or so. 😅

The below charts show the shoes worn by all IFSC bouldering and lead finalists
in the 2022 season. This data was gathered visually as I watched the climbing
finals this past year, so my apologizes if there are any inaccurancies. If you
do find errors, please let me know and I'll update the charts!

While these shoes may not be the best for everyone, I found that they are a
great starting point for someone like me, who is looking for agressive
...
3. Mia Krampl appears to wear a different shoe on each feet - Scarpa Drago
...
- [Drone HV](https://madrock.com/collections/shoes/products/drone)
  | [LV](https://madrock.com/collections/shoes/products/drone-lv)
...
Interested in seeing the age and height distribution of the finalists? See my
previous posts:
