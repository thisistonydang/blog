...
- The official D3 Svelte [example](https://d3js.org/getting-started) uses D3's
  built-in axis generators combined with Svelte's reactive statements for
  rendering axes. While this approach is concise, I found it less intuitive and
  it doesn't allow for server-side rendering (SSR).
